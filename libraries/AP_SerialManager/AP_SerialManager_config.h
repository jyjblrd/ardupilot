...
// Motor control output protocol
#define AP_SERIALMANAGER_MCOUT_BAUD            921600
#define AP_SERIALMANAGER_MCOUT_BUFSIZE_RX      0
#define AP_SERIALMANAGER_MCOUT_BUFSIZE_TX      2048
