...
enum tuning_func {
    ...
    TUNING_MCOUT_ROLL_TRIM =            60, // body-frame roll bias added to the normalized MCOUT PID command
    TUNING_MCOUT_PITCH_TRIM =           61  // body-frame pitch bias added to the normalized MCOUT PID command
};
